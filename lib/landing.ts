import { Bell, CreditCard, PieChart, Receipt, Users, CalendarClock } from "lucide-react";
...
export const FEATURES = [
  ...
  },
  {
    ...
    color: "text-green-600",
    description:
      "Instant notifications when expenses are added or settled.",
  }
];
...
export const TESTIMONIALS = [
  {
    quote:
      "Ye babu rao ka style hai! With Balance, I finally stopped getting confused about who paid for what!",
    name: "Babu Rao",
  ...
  {
    quote:
      "Balance's calculations are so accurate, they're even better than my scheme to double money in 25 days!",
    name: "Raju",
  ...
  {
    quote:
      "If that I have Balance, Raju wont get away with selling my shoes and coat! I'll add to his debt!",
    name: "Shyam",
